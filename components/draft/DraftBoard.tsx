...
export function DraftBoard() {
  ...
  const handleRemoveHero = (team: "your" | "enemy", position: number) => {
    const hero = team === "your" ? draftState.yourTeam[position] : draftState.enemyTeam[position];
    ...
    if (hero) {
      addToast({
        type: "info",
        title: "Hero Removed",
        description: `${hero.localized_name} removed from ${team === "your" ? "your" : "enemy"} team`,
        duration: 2500,
      });
    }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center">
        <div className="text-center space-y-6 p-8">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-white">Loading Dota 2 Draft Analyzer</h2>
            <p className="text-slate-300">Fetching hero data and statistics...</p>
            ...
            <div className="flex items-center justify-between">
              <CardTitle className="text-2xl font-bold text-white flex items-center gap-3">
                ...
                <Badge 
                  ...
                  className={`ml-2 transition-all duration-200 ${
                    suggestionsLoading ? 'animate-pulse bg-emerald-600/20 border-emerald-500/50 text-emerald-300' : ''
                  }`}
                >
                  {suggestionsLoading ? (
                    <>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={suggestionsLoading || progress.enemyTeamPicks === 0}
                  variant="default"
                ...
                <Button
                  onClick={() => {
                    ...
                    addToast({
                      type: "info",
                      title: "Draft Reset",
                      description: "All heroes have been cleared from both teams",
                      duration: 2500,
                    });
                  }}
                  variant="outline"
        ...
        <Card className="bg-gradient-to-r from-slate-800/40 to-slate-700/30 border-slate-600/50 shadow-lg">
          <CardContent className="p-4">
            <div className="flex gap-2 justify-center">
              ...
              <Button
                variant={pickingMode === "suggestions" ? "default" : "outline"}
                ...
                <CardContent className="space-y-2">
                  {suggestions.slice(0, 3).map((suggestion, index) => (
                    <div
                      ...
                      onClick={() => handleSuggestionSelect(suggestion.hero.id)}
                    >
                      <Badge className={`${index === 0 ? 'bg-gradient-to-br from-amber-400 to-orange-500 text-black' : index === 1 ? 'bg-gradient-to-br from-emerald-500 to-cyan-500' : 'bg-gradient-to-br from-slate-500 to-slate-600'} text-white min-w-[24px] justify-center font-bold shadow-lg`}>
                        {index + 1}
                      </Badge>
            ...
            <Card className="bg-gradient-to-br from-slate-900/90 to-slate-800/80 border-slate-700/60 shadow-xl backdrop-blur-sm">
              <CardHeader className="pb-3 border-b border-slate-700/50">
                <CardTitle className="text-lg flex items-center gap-2">
                  ...
                  <span className="text-slate-200 font-bold">Draft Progress</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-slate-700/50">
                    <span className="text-slate-300 font-medium">Total Progress:</span>
